...
export function CartProvider({ children }) {
  ...
  // Returns { ok } or { conflict: true } if the item is from a different shop.
  ...
  // Force-replace the cart with a new shop's item (used after a conflict prompt).
  ...
  // delta is +1 or -1; removes the item once its quantity would drop to 0.
